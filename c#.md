[C#](https://en.wikipedia.org/wiki/C_Sharp_(programming_language)) (/si ʃɑːrp/ see sharp) is a general-purpose, [multi-paradigm programming language](https://en.wikipedia.org/wiki/Multi-paradigm_programming_language).  

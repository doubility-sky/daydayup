A [computer virus](https://en.wikipedia.org/wiki/Computer_virus) is a type of computer program that, when executed, replicates itself by modifying other computer programs and inserting its own code. When this replication succeeds, the affected areas are then said to be "infected" with a computer virus.
...
- [病毒详解及批处理病毒制作：自启动、修改密码、定时关机、蓝屏、进程关闭](https://zhuanlan.zhihu.com/p/106899485)
...
### Zeus
- [Zeus](https://github.com/Visgean/Zeus) trojan horse - leaked in 2011, I am not the author. This repository is for study purposes only, do not message me about your lame hacking attempts.

### H2Miner
- [WebLogic漏洞最新情报：H2Miner双杀操作系统挖矿](https://www.freebuf.com/vuls/254488.html)
- [应急响应案例：kdevtmpfsi挖矿木马](https://cloud.tencent.com/developer/article/1744547)
- [大战蠕虫病毒](https://bbs.huaweicloud.com/blogs/202738)
- [Linux服务器遭遇挖矿蠕虫攻击，已有数千台服务器中招](https://guanjia.qq.com/news/n3/2581.html)
- [《2019年云上挖矿僵尸网络趋势报告》首发：挖矿木马全面蠕虫化](https://developer.aliyun.com/article/743012?spm=a2c6h.14164896.0.0.28fe19b74AvWUg)
- [威胁快报|Redis RCE导致h2Miner蠕虫新一轮爆发，建议用户及时排查以防事态升级](https://developer.aliyun.com/article/741602)
- [How to clean kdetmpdevfsi or .ICEd-unix suspicious files/folders or processes](https://gist.github.com/yoyosan/5f88c1a023f006f952d7378bdc7bcf01)
...
<details> <summary> View Mal-Shell </summary>

```shell
#!/bin/sh
# NOTE: Don't run this shell !!!
exit 0
ulimit -n 65535
...
- [AntiSpy](https://github.com/mohuihui/antispy) is a free but powerful anti virus and rootkits toolkit.It offers you the ability with the highest privileges that can detect,analyze and restore various kernel modifications and hooks.With its assistance,you can easily spot and neutralize malwares hidden from normal detectors.



## Resources
- [virii](https://github.com/guitmz/virii): Collection of ancient computer virus source codes
- [malware](https://github.com/kaiserfarrell/malware): For education purpose only Virus source code and malware code
- [CuteVirusCollection](https://github.com/MinhasKamal/CuteVirusCollection): A Collection of Cute But Deadly Viruses (small-unharmful-annoying-harmless-funny-computer-malware-virus-worm-windows-xp-7-10)
...
- [virus](https://github.com/Ascotbe/virus): 病毒&免杀脚本&乱七八糟的脚本
